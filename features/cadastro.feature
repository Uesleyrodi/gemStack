...
Funcionalidade: Cadastro de produtos
    ...
    Sendo um adiministrado de catálogo
    Posso cadastrar um novo produtos
    ...
    @auth @doing
    Cenario: Duplicado
        O gestor de catálogo tenta cadastrar um produto, porem o mesmo
        ...
        Quando eu faço o cadastro desse item
        Então devo ver a notificaçao "Oops - Este produto já foi cadastrado!"